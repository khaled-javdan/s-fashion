      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            // Borders are PHYSICAL (border-r / border-l) to match the
            // physical positioning above (left-0 / right-0). Logical
            // border-s / border-e would flip in RTL and land on the
            // viewport edge instead of the content-facing edge.
